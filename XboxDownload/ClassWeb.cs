    ...
    class ClassWeb
    {
        ...
        public static SocketPackage HttpRequest(String url, String method, String postdata, String referer, Boolean redirect, Boolean ajax, Boolean decode, String charset, String contenttype, String[] headers, String useragent, CookieContainer cookies, IPEndPoint localEP, String proxyaddress, Int32 proxyport, String proxyauthorization, Int32 sendtimeout = 15000, Int32 receivetimeout = 30000, Int32 autoredirect = 1, String connectHost = null, Boolean speedtest = false)
        {
            ...
            if (String.IsNullOrEmpty(proxyaddress))
            {
                ...
                if (uri.Scheme == "https")
                    socketPackage = SslRequest(uri, null, sSend, host, connectHost, uri.Port, redirect, decode, charset, useragent, cookies, localEP, proxyaddress, proxyport, proxyauthorization, sendtimeout, receivetimeout, autoredirect, headers, speedtest);
                else
                    socketPackage = TcpRequest(uri, sSend, host, connectHost, uri.Port, redirect, decode, charset, useragent, cookies, localEP, proxyaddress, proxyport, proxyauthorization, sendtimeout, receivetimeout, autoredirect, headers, speedtest);
            }
            else
            {
                if (uri.Scheme == "https")
                {
                    ...
                    socketPackage = SslRequest(uri, sTunnels, sSend, host, proxyaddress, proxyport, redirect, decode, charset, useragent, cookies, localEP, proxyaddress, proxyport, proxyauthorization, sendtimeout, receivetimeout, autoredirect, headers, speedtest);
                }
                else
                {
                    ...
                    socketPackage = TcpRequest(uri, sSend, host, proxyaddress, proxyport, redirect, decode, charset, useragent, cookies, localEP, proxyaddress, proxyport, proxyauthorization, sendtimeout, receivetimeout, autoredirect, headers, speedtest);
                }
            }
            return socketPackage;
        }
        ...
        private static SocketPackage TcpRequest(Uri uri, StringBuilder sSend, String targetHost, String connectHost, Int32 connectPort, Boolean redirect, Boolean decode, String charset, String useragent, CookieContainer cookies, IPEndPoint localEP, String proxyaddress, Int32 proxyport, String proxyauthorization, Int32 receivetimeout, Int32 sendtimeout, Int32 autoredirect, String[] headers, Boolean speedtest)
        {
            ...
            if (!String.IsNullOrEmpty(location) && redirect)
            {
                if (autoredirect <= 5)
                {
                    ...
                    socketPackage = HttpRequest(location, "GET", null, socketPackage.Uri.ToString(), true, false, decode, charset, null, headers, useragent, cookies, localEP, proxyaddress, proxyport, proxyauthorization, sendtimeout, receivetimeout, autoredirect++);
                }
                else
                {
        ...
        private static SocketPackage SslRequest(Uri uri, StringBuilder sTunnels, StringBuilder sSend, String targetHost, String connectHost, Int32 connectPort, Boolean redirect, Boolean decode, String charset, String useragent, CookieContainer cookies, IPEndPoint localEP, String proxyaddress, Int32 proxyport, String proxyauthorization, Int32 receivetimeout, Int32 sendtimeout, Int32 autoredirect, String[] headers, Boolean speedtest)
        {
            ...
            if (!String.IsNullOrEmpty(location) && redirect)
            {
                if (autoredirect <= 5)
                {
                    ...
                    socketPackage = HttpRequest(location, "GET", null, socketPackage.Uri.ToString(), redirect, false, decode, charset, null, headers, useragent, cookies, localEP, proxyaddress, proxyport, proxyauthorization, sendtimeout, receivetimeout, autoredirect++);
                }
                else
                {
                    socketPackage.Err = "此页面不能正确地重定向";
